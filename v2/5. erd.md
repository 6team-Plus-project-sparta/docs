...
> - BOOKING.status 추가
> - EVENT.status, EVENT.round_number, EVENT.sale_start_at, EVENT.sale_end_at, EVENT.created_by 추가
> - SEAT.seat_number 삭제 (row_name + col_num 유지)
> - VENUE.capacity 삭제
> - PAYMENT.method, PAYMENT.refunded_at 추가
> - TICKET, REFUND, PAYMENT_TRANSACTION_LOG, AUDIT_LOG 테이블 삭제
