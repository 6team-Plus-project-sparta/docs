...
| `DB_URL` | `jdbc:mysql://{RDS_ENDPOINT}:3306/ticketflow` | 앱 DB 연결 |
...
services:
  mysql:
    image: mysql:8.0
    container_name: ticketflow-mysql
    environment:
  ...
  app:
    ...
    ports:
      - "8080:8080"
    environment:
      DB_URL: jdbc:mysql://mysql:3306/ticketflow
      REDIS_HOST: redis
